    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(choices=[('BCA', 'BCA'), ('BSC', 'BSC'), ('BCOM', 'BCOM'), ('MSC', 'MSC'), ('BBA', 'BBA'), ('MBA', 'MBA')], max_length=100, null=True)),
                ('year', models.CharField(choices=[('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], max_length=100, null=True)),
                ('section', models.CharField(choices=[('NOPE', 'NOPE')('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Attendence',
